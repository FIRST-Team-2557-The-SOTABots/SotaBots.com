...
<div id="aside">
	...
	<div id="content">
<h1 id="BD">Build</h1>
	<h2>About Our Robot</h2>
	<b>Features</b>
	<ul>
	<li>Auburn Mountainview Finalist Alliance</li>
	<li>QS 18 Ast 300  TC 140  Auto 260  Teleop 523</li>
	<li>6 wheel drive - 4 high traction,2 omni-wheel</li>
	<li>7:1 Super shifters</li>
	<li>Catapult powered by high grade surgical tubing</li>
	<li>Intake picks up and passes</li>
    <li>Autonomous consistently scores in high goal</li>
    <li>On board camera to detect hot goal</li>
	</ul>
	</div><!--content-->
</div><!--aside-->
<div id="footer">
